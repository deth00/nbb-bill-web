    ...
    <div class="row mb-4">
        <div class="col-12">
            <table width="100%" class="border-buttom">
                ...
                <tr>
                    <td style="padding-top: 20px;" width="350px" height="140px"><span style="font-family: 'Phetsarath OT'; padding-left: 10px;">{{$data['note']}}</span></td>
                    <td></td>
                </tr>
                <tr>
                    <td style="padding-top: 55px;" width="350px"><span style="font-family: 'Phetsarath OT'; padding-left: 10px;">{{$data['money_name']}}</span></td>
                    <td></td>
                </tr>
            </table>
