            ...
            <div class="card widget-box-three">
                <div class="card-body">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-uppercase font-weight-medium text-truncate mb-2">ລາຍການໃບມອບ</p>
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card widget-box-three">
                <div class="card-body">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-uppercase font-weight-medium text-truncate mb-2">ລາຍການໃບຖອນ</p>
                        <h2 class="mb-0"><span data-plugin="counterup"></span> <i
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card widget-box-three">
                <div class="card-body">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-uppercase font-weight-medium text-truncate mb-2">ລາຍການໃບໂອນ</p>
                        <h2 class="mb-0"><span data-plugin="counterup"></span><i
                                class="mdi mdi-arrow-down text-danger font-24"></i></h2>
                        <p class="text-muted mt-2 m-0"><span class="font-weight-medium">ລວມ:</span> ລາຍການ</p>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card widget-box-three">
                <div class="card-body">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-uppercase font-weight-medium text-truncate mb-2">ລາຍການໃບມອບສິດການໂອນ</p>
                        <h2 class="mb-0"><span data-plugin="counterup"></span> <i
                                class="mdi mdi-arrow-up text-success font-24"></i></h2>
                        <p class="text-muted mt-2 m-0"><span class="font-weight-medium">ລວມ:</span>  ລາຍການ</p>
                    </div>
